...
import morgan from "morgan"; // <-- NEW: Import Morgan logger
import helmet from "helmet"; // <-- NEW: Import Helmet security headers
...
app.use(helmet());            // <-- NEW: Protects headers
app.use(morgan("combined"));  // <-- NEW: Production format logs
app.use(express.json());      // Keeps your existing JSON body parser intact
